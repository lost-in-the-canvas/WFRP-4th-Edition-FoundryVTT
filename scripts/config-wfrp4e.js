...
WFRP4E.conditionDescriptions = {
  ...
  "fatigued" : "You are exhausted or stressed, and certainly in need of rest. You suﬀer a –10 penalty to all Tests. Removing a Fatigued Condition normally requires rest, a spell, or a divine eﬀect, though in some instances, such as when a <a class='condition-chat'><i class='fas fa-user-injured'></i> Fatigued</a> Condition is caused by carrying too much (see Encumbrance), simply changing your circumstances (carrying fewer trappings, for example) can remove a Condition.",
  ...
  "fear" : "When subject to Fear, you suffer –1 SL on all Tests to affect the source of your fear. You may not move closer to whatever is causing Fear without passing a <b>Challenging (+0) Cool</b> Test. If it comes closer to you, you must pass a <b>Challenging (+0) Cool</b> Test, or gain a <a class='condition-chat'><i class='fas fa-user-injured'></i> Broken</a> Condition"
}
...
WFRP4E.symptomDescriptions = {
  ...
  "gangrene" : "Your ﬂesh is turning black, dying, infected with something awful, and it isn’t going to get better. Roll percentile dice to determine a <a class ='table-click' data-table='hitloc'><i class='fas fa-list'></i> Hit Location</a>. If you roll Body, luckily the Gangrene did not settle in during this infection. If you roll Head, your nose is aﬀected. If you roll Arms, it’s your fingers. If you roll Leg, it’s your feet. Each day, roll an <b>Average (+20) Endurance</b> Test. If you pass, you hold oﬀ the Gangrene; if you fail, it grows worse. If you ever fail more times than you have Toughness Bonus, you completely lose all capability with the aﬀected location. If this occurs, use the same rules as Amputated Parts. For as long as you have Gangrene, suﬀer a penalty –10 to all Fellowship Tests, and suﬀer the Wounded symptom. Further, if not already suffering it, you also suﬀer from Blight until the aﬀected tissue is amputated; this remains even if you are cured of the disease that started the Gangrene. ",
  ...
  "malaise" : "You don’t feel at all well. You are tired, find it hard to concentrate, and just generally ill. Take a <a class='condition-chat'><i class='fas fa-user-injured'></i> Fatigued</a> Condition that you can only remove when you have recovered from your illness. ",
  ...
  "delirium" : "Your sensibility comes and goes, with moments of clarity replaced suddenly by bouts of raving, hallucinations, and terror. Make a <b>Challenging (+0) Willpower Test</b> each hour, and consult the <a class='table-click' data-table='delirium'><i class='fas fa-list'></i> Delirium</a> table.",
